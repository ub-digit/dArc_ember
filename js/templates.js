...
function program1(depth0,data) {
  ...
  data.buffer.push("<div class=\"container-fluid\">	\n	<div class=\"page-head\">\n		<div class=\"row v-align\">\n\n			<div class=\"col-xs-9\">\n				<h1>");
  data.buffer.push(escapeExpression((helper = helpers.translateString || (depth0 && depth0.translateString),options={hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data},helper ? helper.call(depth0, "STRINGS.PAGES.ARCHIVE.CREATE", options) : helperMissing.call(depth0, "translateString", "STRINGS.PAGES.ARCHIVE.CREATE", options))));
  data.buffer.push("</h1>\n			</div>\n		</div> <!-- end row --> \n	</div> <!-- end page-head --> \n\n	");
  ...
  data.buffer.push(escapeExpression((helper = helpers.translateString || (depth0 && depth0.translateString),options={hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data},helper ? helper.call(depth0, "STRINGS.FIELDS.UNIT_TITLE.ARCHIVE", options) : helperMissing.call(depth0, "translateString", "STRINGS.FIELDS.UNIT_TITLE.ARCHIVE", options))));
  data.buffer.push(":<br/>\n					");
  ...
  data.buffer.push("\n				</label>\n			</div>\n\n			<div>\n				<label class=\"control-label\">");
  data.buffer.push(escapeExpression((helper = helpers.translateString || (depth0 && depth0.translateString),options={hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data},helper ? helper.call(depth0, "STRINGS.FIELDS.UNIT_ID.ARCHIVE", options) : helperMissing.call(depth0, "translateString", "STRINGS.FIELDS.UNIT_ID.ARCHIVE", options))));
  data.buffer.push(":<br/>\n					");
  data.buffer.push(escapeExpression((helper = helpers.input || (depth0 && depth0.input),options={hash:{
    'type': ("text"),
    'classBinding': (":form-control"),
...
function program10(depth0,data) {
  ...
  data.buffer.push(escapeExpression((helper = helpers.translateString || (depth0 && depth0.translateString),options={hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data},helper ? helper.call(depth0, "STRINGS.FIELDS.ABSTRACT", options) : helperMissing.call(depth0, "translateString", "STRINGS.FIELDS.ABSTRACT", options))));
  data.buffer.push(":</th>\n					<td>");
  data.buffer.push(escapeExpression((helper = helpers.fixNewLine || (depth0 && depth0.fixNewLine),options={hash:{},hashTypes:{},hashContexts:{},contexts:[depth0,depth0],types:["ID","ID"],data:data},helper ? helper.call(depth0, "model.abstract", "", options) : helperMissing.call(depth0, "fixNewLine", "model.abstract", "", options))));
  data.buffer.push("</td>\n				</tr>\n			</table>\n		</div>\n		<div class=\"col-xs-1\">\n			<button ");
  data.buffer.push(escapeExpression(helpers['bind-attr'].call(depth0, {hash:{
...
function program6(depth0,data) {
  ...
  data.buffer.push(">");
  data.buffer.push(escapeExpression((helper = helpers.translateString || (depth0 && depth0.translateString),options={hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data},helper ? helper.call(depth0, "STRINGS.BUTTON.CREATE_AUTHORITY", options) : helperMissing.call(depth0, "translateString", "STRINGS.BUTTON.CREATE_AUTHORITY", options))));
  data.buffer.push("</button>\n			<!--\n			<button ");
  data.buffer.push(escapeExpression(helpers['bind-attr'].call(depth0, {hash:{
...
function program1(depth0,data) {
  ...
  data.buffer.push("<div class=\"container-fluid\">	\n	<div class=\"page-head\">\n		<div class=\"row v-align\">\n			<div class=\"col-xs-9\">\n				<h1>");
  data.buffer.push(escapeExpression((helper = helpers.translateString || (depth0 && depth0.translateString),options={hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data},helper ? helper.call(depth0, "STRINGS.PAGES.AUTHORITY.CREATE", options) : helperMissing.call(depth0, "translateString", "STRINGS.PAGES.AUTHORITY.CREATE", options))));
  data.buffer.push("</h1>\n			</div>\n		</div> <!-- end row --> \n	</div> <!-- end page-head --> \n	");
  stack1 = helpers['if'].call(depth0, "hasErrors", {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(1, program1, data),contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("	\n	<div class=\"row\">\n		<div class=\"col-xs-10\">\n			<div>\n				<label class=\"control-label\">");
...
function program3(depth0,data) {
  ...
  data.buffer.push("<div class=\"container-fluid\">	\n	<div class=\"page-head\">\n		<div class=\"row v-align\">\n			<div class=\"col-xs-9\">\n				<h1>");
  data.buffer.push(escapeExpression((helper = helpers.translateString || (depth0 && depth0.translateString),options={hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data},helper ? helper.call(depth0, "STRINGS.PAGES.DISK.CREATE", options) : helperMissing.call(depth0, "translateString", "STRINGS.PAGES.DISK.CREATE", options))));
  data.buffer.push("</h1>\n			</div>\n		</div> <!-- end row --> \n	</div> <!-- end page-head --> \n\n	");
  stack1 = helpers['if'].call(depth0, "hasErrors", {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(1, program1, data),contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("	\n	<div class=\"row\">\n		<div class=\"col-xs-10\">\n\n			<div>\n				<label class=\"control-label\">");
  data.buffer.push(escapeExpression((helper = helpers.translateString || (depth0 && depth0.translateString),options={hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data},helper ? helper.call(depth0, "STRINGS.FIELDS.UNIT_TITLE.DISK", options) : helperMissing.call(depth0, "translateString", "STRINGS.FIELDS.UNIT_TITLE.DISK", options))));
  data.buffer.push(":<br/>\n					");
  data.buffer.push(escapeExpression((helper = helpers.input || (depth0 && depth0.input),options={hash:{
    'type': ("text"),
    'classBinding': (":form-control"),
  ...
  data.buffer.push("\n				</label>\n			</div>\n\n\n			<div>\n				<label class=\"control-label\">");
  data.buffer.push(escapeExpression((helper = helpers.translateString || (depth0 && depth0.translateString),options={hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data},helper ? helper.call(depth0, "STRINGS.FIELDS.UNIT_ID.DISK", options) : helperMissing.call(depth0, "translateString", "STRINGS.FIELDS.UNIT_ID.DISK", options))));
  data.buffer.push(":<br/>\n					");
  data.buffer.push(escapeExpression((helper = helpers.input || (depth0 && depth0.input),options={hash:{
    'type': ("text"),
    'classBinding': (":form-control"),
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("</span></small>\n			</div>\n			<div class=\"col-sm-12\">\n				<small><address><i class=\"fa fa-envelope\"></i> ");
  ...
  data.buffer.push("</address></small>\n			</div>\n			<!--\n			<div class=\"col-sm-12\">\n				");
...
function program9(depth0,data) {
  ...
  stack1 = (helper = helpers['link-to'] || (depth0 && depth0['link-to']),options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(3, program3, data),contexts:[depth0],types:["STRING"],data:data},helper ? helper.call(depth0, "archives.new", options) : helperMissing.call(depth0, "link-to", "archives.new", options));
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n        </li>\n        <li>     ");
  stack1 = (helper = helpers['link-to'] || (depth0 && depth0['link-to']),options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(5, program5, data),contexts:[depth0],types:["STRING"],data:data},helper ? helper.call(depth0, "disks.new", options) : helperMissing.call(depth0, "link-to", "disks.new", options));
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n        </li>\n        <!--\n        <li>\n          ");
  stack1 = (helper = helpers['link-to'] || (depth0 && depth0['link-to']),options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(7, program7, data),contexts:[depth0],types:["STRING"],data:data},helper ? helper.call(depth0, "authorities", options) : helperMissing.call(depth0, "link-to", "authorities", options));
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n        </li>\n        <li>\n          ");
  stack1 = (helper = helpers['link-to'] || (depth0 && depth0['link-to']),options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(9, program9, data),contexts:[depth0],types:["STRING"],data:data},helper ? helper.call(depth0, "archives", options) : helperMissing.call(depth0, "link-to", "archives", options));
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n        </li>\n        -->\n      </ul>\n\n    </div><!-- /.navbar-collapse -->\n  </div><!-- /.container-fluid -->\n</nav>");
  return buffer;
